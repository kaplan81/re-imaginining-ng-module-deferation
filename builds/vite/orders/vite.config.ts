...
/**
 * The `orders` remote, compiled by Vite and exposed over classic Module
 * Federation.
 *
...
export default defineConfig({
  plugins: [
    ...
    federation({
      ...
      // The alias resolves into `projects/orders/src/app/orders/` - the same
  ...
  css: {
    preprocessorOptions: {
      scss: { loadPaths: ['../../../projects/orders/styles'] },
    },
  },
