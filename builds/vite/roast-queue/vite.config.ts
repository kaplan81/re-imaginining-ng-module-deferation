...
/**
 * The `roast-queue` remote, compiled by Vite and exposed over classic Module
 * Federation.
 *
...
export default defineConfig({
  plugins: [
    ...
    federation({
      ...
      // The alias resolves into `projects/roast-queue/src/app/roast-queue/` - the same
      ...
      exposes: {
        './Widgets': '@rr/roast-queue/roast-queue.widgets',
      },
  ...
  css: {
    preprocessorOptions: {
      scss: { loadPaths: ['../../../projects/roast-queue/styles'] },
    },
  },
