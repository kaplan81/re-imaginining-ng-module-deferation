...
/**
 * The `roast-queue` remote, compiled by Rspack and exposed over classic Module
 * Federation.
 *
...
export default createConfig({
  options: {
    ...
    stylePreprocessorOptions: {
      includePaths: ['../../../projects/roast-queue/styles'],
    },
    ...
    devServer: { port: 4214, hmr: false, liveReload: false },
  },
